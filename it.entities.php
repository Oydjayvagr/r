...
return [
    ...
    'recently_created_books' => 'Argomenti creati di recente',
    'recently_created_shelves' => 'Settori Creati Di Recente',
    ...
    'shelf' => 'Settore',
    'shelves' => 'Settori',
    'x_shelves' => ':count Settore|:count Settori',
    'shelves_long' => 'Settori',
    'shelves_empty' => 'Nessun settore è stata creato',
    'shelves_create' => 'Crea Nuovo Settore',
    'shelves_popular' => 'Settori Popolari',
    'shelves_new' => 'Nuovi Settori',
    'shelves_new_action' => 'Nuovo Settore',
    'shelves_popular_empty' => 'I Settori più popolari appariranno qui.',
    'shelves_new_empty' => 'I Settori creati più di recente appariranno qui.',
    'shelves_save' => 'Salva Settore',
    'shelves_books' => 'Argomenti in questo settore',
    'shelves_add_books' => 'Aggiungi argomenti a questo settore',
    'shelves_drag_books' => 'Trascina i argomenti qui per aggiungerli a questo settore',
    'shelves_empty_contents' => 'Questo settore non ha argomenti assegnati',
    'shelves_edit_and_assign' => 'Modifica il settore per assegnare gli argomenti',
    'shelves_edit_named' => 'Modifica Settore :name',
    'shelves_edit' => 'Modifica Settore',
    'shelves_delete' => 'Elimina Settore',
    'shelves_delete_named' => 'Elimina Settore :name',
    'shelves_delete_explain' => "Il Settore ':name' verrà eliminato. Gli argomenti contenuti non verranno eliminati.",
    'shelves_delete_confirmation' => 'Sei sicuro di voler eliminare questo settore?',
    'shelves_permissions' => 'Permessi Settore',
    'shelves_permissions_updated' => 'Permessi Settore Aggiornati',
    'shelves_permissions_active' => 'Permessi Attivi Settore',
    'shelves_permissions_cascade_warning' => 'I permessi sui settori non si estendono automaticamente agli argomenti contenuti. Questo avviene in quanto un argomento può essere presente in più settori. I permessi possono comunque essere copiati agli argomenti contenuti usando l\'opzione qui sotto.',
    'shelves_copy_permissions_to_books' => 'Copia Permessi agli argomenti',
    'shelves_copy_permissions' => 'Copia Permessi',
    'shelves_copy_permissions_explain' => 'Verranno applicati tutti i permessi del settore agli argomenti contenuti. Prima di attivarlo, assicurati che ogni permesso di questo settore sia salvato.',
    'shelves_copy_permission_success' => 'Permessi del settore copiati in :count argomenti',

    // Books
    'book' => 'Argomento',
    'books' => 'Argomenti',
    'x_books' => ':count Argomento|:count Argomenti',
    'books_empty' => 'Nessun argomento è stato creato',
    'books_popular' => 'Argomenti Popolari',
    'books_recent' => 'Argomenti Recenti',
    'books_new' => 'Nuovi Argomenti',
    'books_new_action' => 'Nuovo Argomento',
    'books_popular_empty' => 'Gli argomenti più popolari appariranno qui.',
    'books_new_empty' => 'Gli argomenti creati più di recente appariranno qui.',
    'books_create' => 'Crea Nuovo Argomento',
    'books_delete' => 'Elimina Argomento',
    'books_delete_named' => 'Elimina l''argomento :bookName',
    'books_delete_explain' => 'Questo eliminerà l''argomento di nome \':bookName\'. Tutte le pagine e i capitoli saranno rimossi.',
    'books_delete_confirmation' => 'Sei sicuro di voler eliminare questo argomento?',
    'books_edit' => 'Modifica Argomento',
    'books_edit_named' => 'Modifica l''argomento :bookName',
    'books_form_book_name' => 'Nome Argomento',
    'books_save' => 'Salva Argometo',
    'books_permissions' => 'Permessi Argomento',
    'books_permissions_updated' => 'Permessi dell''argomento aggiornati',
    'books_empty_contents' => 'Non ci sono pagine o capitoli per questo argomento.',
    'books_empty_create_page' => 'Crea una nuova pagina',
    'books_empty_sort_current_book' => 'Ordina l''argomento corrente',
    'books_empty_add_chapter' => 'Aggiungi un capitolo',
    'books_permissions_active' => 'Permessi argomento attivi',
    'books_search_this' => 'Cerca in questo argomento',
    'books_navigation' => 'Navigazione Argomento',
    'books_sort' => 'Ordina il contenuto dell''argomento',
    'books_sort_named' => 'Ordina l''argomento :bookName',
    ...
    'books_sort_show_other' => 'Mostra Altri Argomenti',
    ...
    'book_tags' => 'Tag Argomento',
    'shelf_tags' => 'Tag Settore',
    'tag' => 'Tag',
    'tags' =>  'Tag',
    'tag_name' =>  'Nome Tag',
    ...
    'profile_not_created_books' => ':userName non ha creato argomenti',
    'profile_not_created_shelves' => ':userName non ha creato alcun settore',
